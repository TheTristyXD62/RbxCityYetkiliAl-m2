...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        .setAuthor({name: "RbxCity | Yetkili Başvuru Sistemi", iconURL: interaction.guild.iconURL({ dynamic: true })})
        ...
        .setFooter({text: "Developed By Tristy"})
        .setTimestamp()
